...
mapnikify(geojson, false, function (err, xml) {
  ...
  map.fromString(xml, {}, function (err, map) {
    ...
    map.render(im, function (err, im) {
      ...
      //   console.log(geojsonBBox, merc.convert(geojsonBBox))

      //   console.log(merc.convert(geojsonBBox, "WGS84"))

      //   console.log(merc.convert(geojsonBBox, "900913"))
...
async function getMapboxImage(bbox) {
    ...
    fs.writeFileSync("xNewBkgnd2.jpg", staticMapImage.data);
  }
